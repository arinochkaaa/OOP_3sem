...
namespace OOP_Lab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //б)
            //var stringFirstVar = "Arina";
            //var stringSecondVar = "Volosyuk";
            ...
            //Console.WriteLine($"\n{stringThirdVar.Insert(2, "Hello ")} - вставка подстроки");
            ////удаление заданной подстроки
            //Console.WriteLine($"{stringThirdVar.Remove(1, 7)} - удаление подстроки");
