...
namespace OOP_Lab12
{
    static class VAVFileManager
    {
        public static void GetFilesAndFoulders(string path)
        {
            ...
            dir.CreateSubdirectory("VAVInspect");
            dir = new(path + "\\VAVInspect");

            string path_dirInfo = "VAVdirinfo.txt";
        ...
        public static void ReplaceTo(string pathFrom, string pathTo, params string[] extens)//перемещение
        {
        ...
        public static void CreateZip(string path)//архивация
        {
            DirectoryInfo dir = new(path);
