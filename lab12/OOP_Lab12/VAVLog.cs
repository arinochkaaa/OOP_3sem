...
namespace OOP_Lab12
{
    static class VAVLog
    {
        private const string PATH_TO_FILE = "VAVlogfile.json";
        ...
        public static void FindByRangeDate(DateTime start, DateTime end)//по диапазону дат
        {
        ...
        public static void FindDate(DateTime date)//по конкретной 
        {
            using (StreamReader sr = new(PATH_TO_FILE))
            {
                var data = sr.ReadToEnd();
